...
from app.printers.print_queue import NORMAL_PRIORITY, YIELDED_PRIORITY, QueuedJob
...
async def test_restore_puts_it_back_to_normal(client, auth_headers, queue, priority_calls):
