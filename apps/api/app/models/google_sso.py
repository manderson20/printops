...
class GoogleSsoSettings(Base, TimestampMixin):
    ...
    # Google Cloud Console (e.g. https://printops.yourschool.org) — can't
    # be reliably derived from the incoming request since uvicorn sits
    # behind a reverse proxy (Caddy) that doesn't forward the original
    # scheme.
