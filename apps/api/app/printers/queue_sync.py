...
def remove_queue(printer_id: str) -> None:
    """Removes this printer's CUPS queue + AirPrint advertisement. Raises
    QueueSyncError on failure — callers should treat this as best-effort and
    not block the printer delete over it."""
